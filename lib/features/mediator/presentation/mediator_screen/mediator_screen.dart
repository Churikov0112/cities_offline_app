...
class _LocalityDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final details = <String>[
      ...
      if (locality.countryCode.isNotEmpty)
        'Код страны: ${locality.countryCode}',
      ...
      if (locality.lat != null && locality.lon != null)
        'Координаты: ${locality.lat}, ${locality.lon}',
      if (locality.displayName.isNotEmpty)
        'Display name: ${locality.displayName}',
    ];
